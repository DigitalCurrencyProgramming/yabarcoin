...
uint256 hashGenesisBlock("0xa98aea69f21cce1991f5fa793babf5a4f009d6edfcdb9f7ed7e47eaecea4ce8b");
...
const string strMessageMagic = "yabarcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // yabarcoin: 1 days
static const int64 nTargetSpacing = 120; // yabarcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal yabarcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "yabarcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2094af41292236ad6f71899cce07f2b103ef756781e206dc6548fa1a8a0fb27c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Building a yabarcoin for a little more entropy ...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1450797137; //epochtime, birthday on christmas 25.12.2015, ha!//block.nTime    = 1451067356; //epochtime, birthday on christmas 25.12.2015, ha!
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 866114; //org:1345972;

        if (fTestNet)
        {
            block.nTime    = 1451067356;
            block.nNonce   = 677333; //org:440824;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2ae926bd4442a168f71ec984efecb2429cdf06abfc74b1bdd8d8e641319a9481"));
